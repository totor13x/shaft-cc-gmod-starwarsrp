...
local function PermissionLoad()
	...
	PermaProps.Permissions["cofounder"] = { Physgun = true, Tool = true, Property = true, Save = true, Delete = true, Update = true, Menu = true, Permissions = true, Inherits = "admin", Custom = true }
	...
	if CAMI then
		...
		for k, v in pairs(CAMI.GetUsergroups()) do
			...
			if k == "superadmin" or k == "founder" or k == "admin" or k == "user" then continue end
